  ...
  <section className="section-dark py-24 md:py-32" id="candidatura">
    <div className="container max-w-3xl mx-auto px-6 text-center">
      <motion.div {...fadeIn}>
        ...
        <h2 className="font-display text-5xl md:text-6xl font-medium leading-tight mb-8 text-section-dark-foreground">
      ...
      <motion.p className="text-section-dark-foreground/70 text-xl leading-relaxed mb-6 font-body font-light" {...fadeIn}>
        Existe uma diferença entre continuar funcionando… e realmente sustentar sua liderança com clareza, energia e equilíbrio.
      </motion.p>

      <motion.p className="text-section-dark-foreground/80 text-xl mb-12 font-body" {...fadeIn}>
