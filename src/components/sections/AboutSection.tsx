    ...
    <div className="container max-w-7xl mx-auto px-6">
      <div className="grid lg:grid-cols-12 gap-12 lg:gap-16 items-center">
        ...
        <div className="lg:col-span-7">
          ...
          <motion.p className="text-muted-foreground text-xl leading-relaxed mb-10 font-body font-light" {...fadeIn}>
          ...
          <motion.div {...fadeIn}>
            <p className="text-foreground text-xl mb-6 font-body font-medium">Sua condução é marcada por:</p>
